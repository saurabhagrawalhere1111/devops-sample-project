...
# Create the GitHub Actions OIDC provider in this account (it doesn't exist yet).
# If your account ALREADY has one, delete this resource and switch the reference
# below back to a `data "aws_iam_openid_connect_provider"` lookup instead.
